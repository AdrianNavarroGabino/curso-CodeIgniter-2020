...
# http://localhost/CodeIgniter/index.php/insert
$route['insert'] = 'ConsultasController/insert';
# http://localhost/CodeIgniter/index.php/update
$route['update'] = 'ConsultasController/update';
